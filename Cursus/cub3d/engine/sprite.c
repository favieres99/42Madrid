...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/21 21:49:24 by gfaviere          #+#    #+#             */
/*   Updated: 2021/02/16 10:17:10 by gfaviere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "engine.h"

static void		init_draw_sprite(t_game *game, t_sprite *sprite, double inv_det,
		t_sprite_draw *spr)
{
...
static int		set_tex_pos(t_game *game, t_sprite_draw *spr, t_tex *tex,
		t_pos *tex_pos)
{
	tex_pos->x = (int)(256
...
static void		draw_sprite_pixel(t_game *game, t_sprite *sprite,
...
static void		draw_sprite(t_game *game, t_sprite *sprite, t_sprite_draw *spr,
		t_tex *tex)
{
