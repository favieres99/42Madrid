...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/24 12:12:24 by gfaviere          #+#    #+#             */
/*   Updated: 2021/03/09 11:32:33 by gfaviere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	case_color(t_game *game, int x, int y)
{
	char	c;
...
static void	draw_minimap(t_game *game, t_window *w, t_pos *start, t_pos *end)
{
	int			i;
	int			j;
	int			color;
