...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/21 21:07:36 by gfaviere          #+#    #+#             */
/*   Updated: 2021/02/08 12:59:48 by gfaviere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_ray(t_raysult *r, t_camera *c, int column, double camera_x)
{
	r->column = column;
