...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/26 11:55:52 by gfaviere          #+#    #+#             */
/*   Updated: 2021/03/15 10:36:24 by gfaviere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		init_config(t_config *config)
{
	...
	config->c[TEX_SKY] = 0xC69C4B;
	config->c[TEX_FLOOR] = 0x75CD91;
	config->map = NULL;
	config->rows = 0;
	config->columns = 0;
	config->save_arg = 0;
...
int			parse_config(t_config *config, char const *conf_path)
{
	...
	{
		r = parse_line(config, line, &map_buffer);
		free(line);
	}
